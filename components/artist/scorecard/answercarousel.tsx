          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex flex-row justify-center gap-4 h-full pb-12 mx-auto">
              <div className="flex flex-col ">
                ...
                <SongCard
                  index={index + `userchoice`}
                  song={round.userChoice}
                />
              </div>
              <div className="flex flex-col h-full">
                <h2 className="mt-4 text-xl font-bold text-zinc-100 group-hover:text-white sm:text-2xl font-display">
                ...
                <SongCard
                  index={index + `correctsong`}
                  song={round.correctSong}
                />
              </div>
            </div>
          </div>
...
function SongCard({ song, index }: { index: string; song: Song }) {
  return (
    <CardNE className="max-w-64" key={index}>
